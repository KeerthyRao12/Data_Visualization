...
<body>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header">
      ...
      Job Role Distribution of Employees
      </button>
    </h2>
  ...
  <div class="accordion-item">
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            <pre>Burnout is the most prevalent mental health condition among employees across various job roles
    ...
    ?>
    <div class="container mt-5">
        <h2 class="text-center">Number of Remote Workers by Age Group</h2>
        <p class="text-center">This chart represents the number of remote workers across different age groups.</p>

        <div class="row">
            <!-- Left column for the table -->
            <div class="col-md-6">
                <h4>Remote Workers by Age Group</h4>
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            <th>Age Range</th>
                            <th>Number of Remote Workers</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        // Displaying age groups and corresponding remote work counts in the table
                        for ($i = 0; $i < count($ageGroups); $i++) {
                            echo "<tr><td>{$ageGroups[$i]}</td><td>{$remoteWorkCounts[$i]}</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
            ...
            <pre>Employees aged 25-34 and 45-54 are significantly more likely to work remotely compared to other age groups.</pre>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: ageGroups, // Age groups from PHP
                    datasets: [{
                        label: 'Number of Remote Workers',
                        data: remoteWorkCounts, // Counts from PHP
                        backgroundColor: getRandomColor(), // Colors from PHP
